...
class NewTasksAdapter :
    ListAdapter<Task, NewTasksAdapter.VH>(MyDiffUtil) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VH {
        ...
        val v = LayoutInflater.from(parent.context)
            .inflate(R.layout.recycler_view_layout_tasks, parent, false)
        return VH(v)
    ...
    override fun onBindViewHolder(holder: VH, position: Int) {
        ...
        holder.btnDelete.setOnClickListener { onClickListener.onClickRemove(holder.adapterPosition) }
